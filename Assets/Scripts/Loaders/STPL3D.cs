...
public class STPL3D : Loader
{
    public int LevelOfDetail = 17;
    ...
    public override void SetNextScene(string sceneID)
    {
        ...
        // }
        LevelOfDetail = Mathf.Min(Mathf.Max(lod_unclamped, 17), 23);
    }

    public override GameObject Load()
    {
        parentObject = new GameObject("STPL");
        string[] dir = Directory.GetDirectories(Config.STPL3D);
        for (int i = 0; i < dir.Length; i++)
        {
            ...
            catch (FileNotFoundException e)
            {
                ...
                while (newLevel>16 && !System.IO.File.Exists(newPath + ".obj"))
                {
                    newLevel--;
